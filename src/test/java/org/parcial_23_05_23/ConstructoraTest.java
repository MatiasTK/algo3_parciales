...
public class ConstructoraTest {
    ...
    @Test
    public void test01CuantoSobraDeConstruirUnaViviendaDe5Ambientes() {
        Cemento cemento = new Cemento(100);
        Canio canio = new Canio(500);
        Pintura pintura = new Pintura(2500);

        Constructora constructora = new Constructora(cemento, canio, pintura);
    ...
    @Test
    public void test02CuantoSobraDeConstruirUnEdificio5Pisos() {
    ...
    @Test
    public void test03CuantoSobraDeConstruirUnComplejo() {
